...
class TestReproducibleFontDownloadUtils:
    ...
    def test_compute_sha256_valid_file(self, tmp_path: pathlib.Path):
    ...
    def test_compute_sha256_with_string_path(self, tmp_path: pathlib.Path):
    ...
    def test_compute_sha256_missing_file(self, tmp_path: pathlib.Path):
    ...
    def test_compute_sha256_directory_raises_error(self, tmp_path: pathlib.Path):
        """Test SHA256 computation for directory raises error."""
        with pytest.raises(FileNotFoundError, match="not a file"):
            ReproducibleFontDownloadUtils.compute_sha256(tmp_path)

    def test_compute_sha256_empty_file(self, tmp_path: pathlib.Path):
    ...
    def test_compute_sha256_large_file(self, tmp_path: pathlib.Path):
...
class TestFontSource:
    ...
    def test_font_source_basic_creation(self):
    ...
    def test_font_source_with_explicit_name(self):
    ...
    def test_font_source_prepare_name_from_url(self):
    ...
    def test_font_source_prepare_name_url_encoded(self):
    ...
    def test_font_source_prepare_name_complex_url(self):
    ...
    def test_font_source_to_dict(self):
...
class TestFontEntity:
    ...
    def test_font_entity_auto_computes_sha256(self, tmp_path: pathlib.Path):
    ...
    def test_font_entity_string_path_converted(self, tmp_path: pathlib.Path):
    ...
    def test_font_entity_to_dict(self, tmp_path: pathlib.Path):
        """Test conversion to dictionary."""
        test_file = tmp_path / "font.ttf"
        test_file.write_bytes(b"content")
    ...
    def test_font_entity_to_config_format_dict(self, tmp_path: pathlib.Path):
    ...
    def test_font_entity_missing_file_raises_error(self, tmp_path: pathlib.Path):
    ...
    def test_font_entity_sha256_override_ignored(self, tmp_path: pathlib.Path):
    ...
    def test_font_entity_slots(self, tmp_path: pathlib.Path):
...
class TestFontSourceAndEntityIntegration:
    ...
    def test_source_to_entity_workflow(self, tmp_path: pathlib.Path):
    ...
    def test_multiple_sources_to_entities(self, tmp_path: pathlib.Path):
    ...
    def test_entity_config_format_matches_json_structure(self, tmp_path: pathlib.Path):
...
class TestEdgeCasesTools:
    ...
    def test_font_entity_with_unicode_content(self, tmp_path: pathlib.Path):
    ...
    def test_font_entity_binary_content(self, tmp_path: pathlib.Path):
